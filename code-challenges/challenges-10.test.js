...
app.get('/aboutme', (req, res) => {
  res.send('I just like to be, to just be');
});
app.get('/favoritefoods', (req, res) => {
  res.send(['tacos', 'double cheese burgers', 'breakfast sandwhiches', 'All things cheese']);
});
...
// const five = input.filter(item => item === target);
// return five;
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
